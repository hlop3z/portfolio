/**
 * OpenSource - plugin_one Component.
 *
 * @component
 *
 ...
 * <plugin_one.OpenSource></plugin_one.OpenSource>
 *
 * // Render the component with custom class and style.
 * <plugin_one.OpenSource class="custom-class" style="color: red;"></plugin_one.OpenSource>
 */